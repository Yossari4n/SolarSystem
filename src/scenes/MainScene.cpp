...
void MainScene::CreateScene() {
    ...
    merkury_ao->Orbit(Orbit(&sun->Transform().Position(), 0.39f * EARTH_ORBIT_RADIUS, -EARTH_ORBIT_ANGULAR_VELOCITY / 0.24f));
    ...
    wenus_ao->Orbit(Orbit(&sun->Transform().Position(), 0.72f * EARTH_ORBIT_RADIUS, -EARTH_ORBIT_ANGULAR_VELOCITY / 0.61f));
    ...
    earth_ao->Orbit(Orbit(&sun->Transform().Position(), EARTH_ORBIT_RADIUS, -EARTH_ORBIT_ANGULAR_VELOCITY));
    ...
    mars_ao->Orbit(Orbit(&sun->Transform().Position(), 1.52f * EARTH_ORBIT_RADIUS, -EARTH_ORBIT_ANGULAR_VELOCITY / 1.88f));
    ...
    jupiter_ao->Orbit(Orbit(&sun->Transform().Position(), 5.2f * EARTH_ORBIT_RADIUS, -EARTH_ORBIT_ANGULAR_VELOCITY / 11.86f));
    ...
    saturn_ao->Orbit(Orbit(&sun->Transform().Position(), 9.54f * EARTH_ORBIT_RADIUS, -EARTH_ORBIT_ANGULAR_VELOCITY / 29.44f));
    ...
    uranus_ao->Orbit(Orbit(&sun->Transform().Position(), 19.19f * EARTH_ORBIT_RADIUS, -EARTH_ORBIT_ANGULAR_VELOCITY / 84.07f));
    ...
    neptun_ao->Orbit(Orbit(&sun->Transform().Position(), 30.06f * EARTH_ORBIT_RADIUS, -EARTH_ORBIT_ANGULAR_VELOCITY / 164.88f));
}
