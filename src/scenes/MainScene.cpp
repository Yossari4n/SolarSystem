...
void MainScene::CreateScene() {
    ...
    auto sun_mr = sun->CreateComponent<MeshRenderer>("/Users/jakubstokowski/Desktop/OpenGL/SolarSystem/models/sun/13902_Earth_v1_l3.obj",
                                                     IDrawable::ShaderTypes::TEXTURE_PURE);
    sun->CreateComponent<AstronomicalObject>(EARTH_ROTATION_SPEED / 1.04f);
    sun->CreateComponent<PointLight>(glm::vec3(0.2f),
                                     glm::vec3(0.8f),
                                     glm::vec3(0.5f),
                                     1.0f,
                                     0.0014f,
    ...
    auto merkury_mr = merkury->CreateComponent<MeshRenderer>("/Users/jakubstokowski/Desktop/OpenGL/SolarSystem/models/merkury/13902_Earth_v1_l3.obj",
                                                             IDrawable::ShaderTypes::TEXTURE_LIGHT_RECEIVER);
    ...
    auto wenus_mr = wenus->CreateComponent<MeshRenderer>("/Users/jakubstokowski/Desktop/OpenGL/SolarSystem/models/wenus/13902_Earth_v1_l3.obj",
                                                         IDrawable::ShaderTypes::TEXTURE_LIGHT_RECEIVER);
    ...
    auto earth_mr = earth->CreateComponent<MeshRenderer>("/Users/jakubstokowski/Desktop/OpenGL/SolarSystem/models/earth/13902_Earth_v1_l3.obj",
                                                         IDrawable::ShaderTypes::TEXTURE_LIGHT_RECEIVER);
    ...
    auto mars_mr = mars->CreateComponent<MeshRenderer>("/Users/jakubstokowski/Desktop/OpenGL/SolarSystem/models/mars/13902_Earth_v1_l3.obj",
                                                       IDrawable::ShaderTypes::TEXTURE_LIGHT_RECEIVER);
    ...
    auto jupiter_mr = jupiter->CreateComponent<MeshRenderer>("/Users/jakubstokowski/Desktop/OpenGL/SolarSystem/models/jupiter/13902_Earth_v1_l3.obj",
                                                             IDrawable::ShaderTypes::TEXTURE_LIGHT_RECEIVER);
    ...
    auto saturn_mr = saturn->CreateComponent<MeshRenderer>("/Users/jakubstokowski/Desktop/OpenGL/SolarSystem/models/saturn/13902_Earth_v1_l3.obj",
                                                           IDrawable::ShaderTypes::TEXTURE_LIGHT_RECEIVER);
    ...
    auto uranus_mr = uranus->CreateComponent<MeshRenderer>("/Users/jakubstokowski/Desktop/OpenGL/SolarSystem/models/uranus/13902_Earth_v1_l3.obj",
                                                           IDrawable::ShaderTypes::TEXTURE_LIGHT_RECEIVER);
    ...
    auto neptun_mr = neptun->CreateComponent<MeshRenderer>("/Users/jakubstokowski/Desktop/OpenGL/SolarSystem/models/neptun/13902_Earth_v1_l3.obj",
                                                           IDrawable::ShaderTypes::TEXTURE_LIGHT_RECEIVER);
